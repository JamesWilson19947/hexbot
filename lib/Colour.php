...
class ColourFind {
	...
	function returnName($colourName){

		$colour1 = $this->hex2rgb($colourName);

		$distanceArray = [];

		foreach($this->colours as $hex => $name){
			
			$colour2 = $this->hex2rgb($hex);
			...
			$distanceArray[$name] = $distance;
		}

		asort($distanceArray);
		return key($distanceArray);
